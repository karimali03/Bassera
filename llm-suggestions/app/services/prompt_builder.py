"""
Assembles the system prompt and user message for the LLM API call.
The system prompt text lives here so it can be unit-tested independently
of the AI engine.
"""
...
def build_user_message(transactions: list[Transaction]) -> str:
    """Serialize the transaction list into the user turn message."""
    payload = [
        {
